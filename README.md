...
Reference: with `--text_encoder_name fuyingw/heart_bert` and the ECG tower initialised from
an ECG-FM checkpoint (`--ecg_encoder_weight`), the above reaches a six-dataset zero-shot
